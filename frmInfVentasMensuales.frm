...
Begin VB.Form frmInfVentasMensuales 
   ...
   ClientTop       =   435
   ClientWidth     =   7425
   Icon            =   "frmInfVentasMensuales.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin AIFCmp1.asxPowerButton cmdImprimir 
      ...
      _ExtentX        =   3201
      _ExtentY        =   873
      Picture         =   "frmInfVentasMensuales.frx":27A2
      Caption         =   "&Imprimir"
      CaptionAlignment=   5
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
   ...
   Begin AIFCmp1.asxPowerButton cmdCancelar 
      ...
      _ExtentX        =   3201
      _ExtentY        =   873
      Picture         =   "frmInfVentasMensuales.frx":28FC
      Caption         =   "&Cancelar"
      CaptionAlignment=   5
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
   ...
   End
End
Attribute VB_Name = "frmInfVentasMensuales"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private rsInfVtas As New ADODB.Recordset
Private rptVentas As New crptVentasXfechas
...
If optTodo.Value = True Then
    rsInfVtas.Open "select * from Ventas order by fecha", cn, adOpenDynamic, adLockOptimistic, adCmdText
Else
    rsInfVtas.Open "select * from Ventas where fecha between #" & Format(dtpDesde.Value, "mm/dd/yyyy") & "# and #" & Format(dtpHasta.Value, "mm/dd/yyyy") & "# order by fecha", cn, adOpenDynamic, adLockOptimistic, adCmdText
End If
If rsInfVtas.RecordCount = 0 Then
    MsgBox "NO HAY INFORMACION PARA EL INFORME ...!", vbInformation, "ATENCION !"
    Exit Sub
End If
rptVentas.Database.SetDataSource rsInfVtas

Set rptGeneral = rptVentas ' Asigna el reporte al objeto reporte general utilizado
                           ' en el Form de la Vista Previa.
frmVistaPrevia.Show vbModal

Set rptVentas = Nothing
rsInfVtas.Close
Set rsInfVtas = Nothing
End Sub
